                ...
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(image: DecorationImage(fit: BoxFit.cover,
                            image: AssetImage(podcast.imageUrl)),borderRadius: BorderRadius.all(Radius.circular(8.0)),
                        ),
                      ),
                    ],
                  ),
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(podcast.artistName,style: TextStyle(
                            color: Colors.white70,fontWeight: FontWeight.w500 ,fontSize: 18, fontStyle: FontStyle.italic),),
                        Text(podcast.musicName,style: TextStyle(
                            color: Colors.white70,fontWeight: FontWeight.w500,fontSize: 12, fontStyle: FontStyle.italic),),
                      ],
                    ),
                  )
                ],
